...
console.log(`Release hardening v87 validation OK — ${checks.length} stale-state, HMI identity, approval audit, attention, KPI fallback, dashboard projection, and runtime-release guards checked.`);
