...
(()=>{
 ...
 function armRefresh(){if(liveMonitoringTimer)return;liveMonitoringTimer=setInterval(()=>{if(view==='live')liveMachines().catch(()=>{});},5000);}
 ...
 window.LiveMonitoringV71={telemetryMap,trustContext,machineCard,armRefresh};
})();
