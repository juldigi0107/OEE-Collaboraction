...
(()=>{
 ...
 async function paint(){
  ...
  const c=m?.data_coverage||{},q=c.quality_units||{},p=c.production_units||{},d=c.pds_currency||{},e=c.energy||{},fp=Array.isArray(m?.release_fingerprint)?m.release_fingerprint:[];
