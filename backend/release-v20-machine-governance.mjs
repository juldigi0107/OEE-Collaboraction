...
export async function handleMachineGovernanceV20(req,env){
 ...
 if(path==='/api/shopfloor/start'){const cfg=await config(env);return cfg?canonicalStart(req,env,cfg):null;}
