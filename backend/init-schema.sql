...
CREATE TABLE IF NOT EXISTS production_runs(id TEXT PRIMARY KEY,machine_id TEXT NOT NULL,pro TEXT NOT NULL,material TEXT,shift TEXT,group_name TEXT,operator_user_id TEXT,status TEXT NOT NULL DEFAULT 'RUNNING',planned_qty REAL,start_counter REAL NOT NULL DEFAULT 0,end_counter REAL,actual_qty REAL NOT NULL DEFAULT 0,good_qty REAL NOT NULL DEFAULT 0,reject_qty REAL NOT NULL DEFAULT 0,start_ts TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,end_ts TEXT,source TEXT NOT NULL DEFAULT 'hmi',version INTEGER NOT NULL DEFAULT 1,unit TEXT,plan_id TEXT);
