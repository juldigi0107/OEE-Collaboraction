...
export default {
 async fetch(req,env,ctx){
  ...
  if(['/api/assets','/api/import-data','/api/readiness','/api/release-manifest','/api/approvals','/api/shopfloor/quality','/api/role-dashboard','/api/shopfloor/start','/api/shopfloor/finish','/api/shopfloor/maintenance/close','/api/realtime/overview'].includes(path))await ensureAdditiveSchema(env);
